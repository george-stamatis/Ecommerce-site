...
export class CheckoutComponent implements OnInit {
  ...
  setupStripePaymentForm() {
    ...
    // add an instance of card UI compontent into the card-element div
    ...
    this.cardElement.on('change', (event:any) => {
      ...
      if (event.complete) {
        ...
        //sjow validation error to customer
  ...
  copyShippingToBilling(checked: boolean) {
    if (checked) {
  ...
  resetCart() {
    ...
    this.router.navigateByUrl("category/2");
